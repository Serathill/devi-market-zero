...
<br><br>
<img width="959" alt="image" src="https://github.com/user-attachments/assets/0bd7fe44-ea6c-435e-b3dd-e494c0600138" />
<br><br>
...
|----------------------|-------------|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| **Product Scan**     | POST        | `https://devi-market-zero-vpqueen.2ky3l1-1.deu-c1.eu1.cloudhub.io/api/product_scan`                  | **Body (JSON):**<br>```json<br>{<br>  "barcode": "1234567890122",<br>  "scan_timestamp": "2025-06-27T14:23:11Z"<br>}```                                                           | Primește datele unei scanări de produs (de la RPi Pico sau Postman) și le inserează/actualizează în baza de date. |
| **List Products**    | GET         | `https://devi-market-zero-vpqueen.2ky3l1-1.deu-c1.eu1.cloudhub.io/api/products`                      | **Parametri de Query (opționali):**<br>• `limit` (Număr, ex: 10)<br>• `page` (Număr, ex: 1)                                                                                        | Returnează o listă paginată de produse. Se pot adăuga parametrii în URL pentru a controla paginarea (ex: `.../products?limit=10&page=1`). |
| **Transfer Products**| *(Intern)*  | *(Nu se aplică)*                                                                                     | *(Nu se aplică)*                                                                                                                                                                   | Acesta este un proces intern, declanșat de un **Scheduler** la fiecare oră. Nu are un endpoint public. |
