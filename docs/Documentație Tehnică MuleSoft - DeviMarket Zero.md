...
|----------------------|-------------|------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|------------------|
| Product Scan         | POST        | https://devi-market-zero-vpqueen.2ky3l1-1.deu-c1.eu1.cloudhub.io/api/product_scan                     | ```json<br>{<br>  "barcode": "1234567890122",<br>  "scan_timestamp": "2025-06-27T14:23:11Z"<br>}```         | Primește datele unei scanări de produs (de la RPi Pico sau Postman) și le inserează/actualizează în baza de date. |
...
| Product by ID        | GET         | https://devi-market-zero-vpqueen.2ky3l1-1.deu-c1.eu1.cloudhub.io/api/products/{productId}            | (N/A)                                                                                                       | Returnează detaliile complete pentru un singur produs, pe baza ID-ului furnizat în URL. |
