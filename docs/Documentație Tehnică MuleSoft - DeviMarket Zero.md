...
|----------------------|-------------|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| **Product Scan**     | POST        | `	https://devi-market-zero-ypueen.2ky31l-1.deu-c1.eu1.cloudhub.io/api/product_scan`                  | **Body (JSON):**```json{ "barcode": "1234567890122", "scan_timestamp": "2025-06-27T14:23:11Z"}```                                                           | Primește datele unei scanări de produs (de la RPi Pico sau Postman) și le inserează/actualizează în baza de date. |
| **List Products**    | GET         | `	https://devi-market-zero-ypueen.2ky31l-1.deu-c1.eu1.cloudhub.io/api/products`                      | **Parametri de Query (opționali):**<br>• `limit` (Număr, ex: 10)<br>• `page` (Număr, ex: 1)                                                                                        | Returnează o listă paginată de produse. Se pot adăuga parametrii în URL pentru a controla paginarea (ex: `.../products?limit=10&page=1`). |
